...
I consulted with my classmate Chelsey Hay on the proper formating of the dictionary append on line 147 (I was using underscores in the keys even though I hadn't defined the keys that way).

I consulted with my classmate Chelsey Hay on the text string on row 137 and included line breaks.

I consulted with my classmate Chelsey Hay on the while loop conditional on line 174, which I intially approached with an if/elif/else function because I didn't see the requirement [Order System, bullet 9] that specified to use a match function here.
