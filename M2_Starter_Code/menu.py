...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection = input("Select the item number you would like?")
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    quantity = input(f"How many {menu_selection_name} would you like? \n"
                     + "(Note: The quantity will default to 1 if your selection \n"
                     + "is invalid)\n")
...
for i in range(len(order_list)):
    ...
    price_spaces = " " * number_price_spaces
    quantity_spaces = " " * number_quantity_spaces
